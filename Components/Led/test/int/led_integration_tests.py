...
def test_blinking(fprime_test_api):
    ...
    # Send to stop blinking, then assert blinking stops
    ...
    # telemetry is emitted every 1 second but assert check immediately so timeout for 2 seconds so telemetry can actually respond
