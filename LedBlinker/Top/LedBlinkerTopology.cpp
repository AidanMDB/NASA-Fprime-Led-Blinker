...
void configureTopology() {
    ...
    // Specify which GPIO pin to control    (gpiochip0: line 30, is P9_ll on physical pins)
    Os::File::Status status = gpioDriver.open("/dev/gpiochip0", 30, Drv::LinuxGpioDriver::GpioConfiguration::GPIO_OUTPUT);
